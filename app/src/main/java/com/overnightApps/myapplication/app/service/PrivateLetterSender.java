 ...
 */
public class PrivateLetterSender extends LetterSender {
    public PrivateLetterSender(Letter originalLetter, User currentUser, LetterDao letterDao) {
        super(originalLetter, currentUser, letterDao);
    }

    @Override
    protected String getUserSignature() {
        return currentUser.getPrivateSignature();
    }
